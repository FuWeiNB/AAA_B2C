                    ...
                    <div class="add-dress">
                        ...
                        <div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
                            <form class="layui-form layui-col-md12  layui-form-pane" style="width:800px;margin:10px 0px 0px 50px;">
                                <input type="hidden" value="${map.a_id }" name="a_id" lay-verify="a_id" />
                                <div class="layui-form-item">
                                    <label class="layui-form-label">收货人</label>
                                    <div class="layui-input-block">
                                        <input type="text" value="${map.a_name}" onkeyup="value=value.replace(/[^\w\u4E00-\u9FA5]/g, '')" style="width:250px;" name="username" id="username" lay-verify="required" lay-reqtext="用户名是必填项，岂能为空？" placeholder="请输入" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="tel" name="phone" value="${map.a_phone }" id="phone" style="width:250px" lay-verify="phone" autocomplete="off" class="layui-input">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="checkbox" name="close" value="${map.a_flag == 0 ? 'on':''}" lay-skin="switch" lay-text="ON|OFF">
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item layui-form-text">
                                    ...
                                    <div class="layui-input-block">
                                        <textarea placeholder="请输入详细地址" value="${map.a_namedetials }" style="width:250px;float:left" class="layui-textarea" lay-verify="texts" name="text"></textarea>
                                        <span id="texts"></span>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        if(close == "on")
        {
            $("input[name='close']").attr("checked",'true');
        }
        var id="${map.a_namedetials }";
        $("textarea[name='text']").text(id);
        ...
        layui.use(['form','code'], function(){
            ...
            form.on('submit(demo1)', function(data) {
                ...
                else
                {
                    ...
                    $.ajax({
                        url: '/person/upd_address',
                        type: "post",
                        data:{"a_namedetials":detialss,"a_phone":phone,"a_name":username,"a_flag":check,"a_id":a_id},
                        dataType: "json",
                        success: function(data) {
                            if(data == 1)
                            {
