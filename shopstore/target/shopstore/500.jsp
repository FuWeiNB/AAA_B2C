...
<body>
	<script type="text/javascript" src="/signsystem/js/jquery.js"></script>
	<div id="wrapper">
		<h1>500</h1>
		<h2>Sorry!数据库连接失败了...</h2>
		<p>
			<a href="/signsystem/Login.jsp">返回主页</a>
		</p>
	</div>
	<canvas width="1366" height="635"></canvas>
...
snow();
	...
	<canvas id="christmasCanvas"
		...
		width="1366" height="635"></canvas>
	<canvas id="christmasCanvas"
		style="top: 0px; left: 0px; z-index: 5000; position: fixed; pointer-events: none;"
		width="1920" height="917"></canvas>
</body>
</html>