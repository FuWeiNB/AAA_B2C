    <%@ page language="java" import="java.util.*" pageEncoding="utf-8"%>
        ...
        <h3>
        <a href="extra-profile.html">登陆人名称</a>
        ...
        <div class="sidebar-menu toggle-others fixed" style="width:280px;height:500px">
        ...
        <!-- logo -->
        <div class="logo">
        <a href="index-1.html" class="logo-expanded">
        <img src="/assets/images/logo@2x.png" width="80" alt="" />
        </a>

        <a href="index-1.html" class="logo-collapsed">
        ...
        <c:forEach var="map" items="${list }">
            <c:if test="${map.mgr == 0 ? true:false }">
                <li>
                <a href="javascript:void(0)" onclick="toshow('${map.url}')">
                <i class="${map.css}"></i>
                ...
                <c:if test="${map.p_id > 100 ? true:false }">
                    ...
                    <c:forEach var="map_son" items="${list }">
                        <c:if test="${map_son.mgr == map.p_id ? true:false }">
                            ...
                            <a href="javascript:void(0)" onclick="toshow('${map_son.url }')" >
                            <li>
        ...
        toastr.info("我叼你吗的", "欢迎亲爱的您登陆~", opts);
        }, 3000);
        ...
        <div class="row">
            <iframe id="show"  style="width:102.5%;height:800px;border: medium none;margin-top:-28px;margin-left:-11px" src="/index.jsp">
