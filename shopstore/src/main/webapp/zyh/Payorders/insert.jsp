...
<script>
    ...
    btn_add.onclick = function(event){
        ...
        newTr.children[6].innerHTML ="<td>"+
           "<input type='text' id='m_oldprice"+count+"' name='m_oldprice' readonly='readonly' style='width:100px;'/>"+
            "</td>"
    ...
    function tocount(obj,count)
    {
        ...
        if(obj == 0||obj=="")
        {
            $("input[id='pay_oldnumber']").css('border','1px solid red');
            if(obj == "")
            {
        ...
        {
            $("input[id='pay_oldnumber']").css('border','1px solid #cccccc');
            ...
            {
                total_num += parseFloat($("input[id='pay_price"+count+"']").val());
