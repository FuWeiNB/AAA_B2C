...
{
    //发件人的邮箱和授权码
    private final String myEmailAccount = "2323865956@qq.com";//发送的邮箱
    private final String myEmailPassword = "sgmzjqjcyfjgebaj";
    ...
    private  String myEmailSMTPServer = "smtp.2323865956.com";
    ...
    public  MimeMessage createMessage(Session session, String sendMail, String receiveMail,String info) throws Exception {
        ...
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "一醉坊", "UTF-8"));
